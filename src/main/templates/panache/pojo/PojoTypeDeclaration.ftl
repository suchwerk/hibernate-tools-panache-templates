 ...
 */
@${pojo.staticImport("io.quarkus.hibernate.orm.panache", "PanacheBaseEntity")}
<#if pojo.isComponent()>
...
${pojo.getClassModifiers()} ${pojo.getDeclarationType()} ${pojo.getDeclarationName()} extends PanacheBaseEntity